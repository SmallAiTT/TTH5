 ...
 * @param name
 */
core4tt.trans2Module = function(src, targetDir, requireArr, name){
 ...
 * @param name
 */
core4tt.merge2Module = function(srcs, target, requireArr, name){
 ...
 * @returns {String}
 */
core4tt.getKeyName = function(name){
